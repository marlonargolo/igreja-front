...
const defaults = {
  Cargos: ['Pastor(a)', 'Presbítero', 'Missionário(a)', 'Diácono', 'Diaconisa', 'Obreiro', 'Membro'],
  Funções: ['Músico', 'Professor EBD', 'Tesoureiro(a)', 'Secretário(a)', 'Líder de Jovens'],
  Grupos: ['Grupo de Louvor', 'Grupo de Jovens', 'Grupo de Crianças'],
  Ministérios: ['Jovens', 'Crianças', 'União de Senhoras', 'Varões', 'Ação Social'],
  Status: ['Ativo', 'Inativo', 'Falecido', 'Congregado', 'Criança', 'Mudou-se'],
}
...
export default function SecretariaConfiguracoes() {
  ...
  return (
    <Layout
      crumbs={[{ label: 'Secretaria' }, { label: 'Configurações' }]}
      ...
      <Card>
        ...
        <CardBody className="pt-2">
          <div className="flex gap-2 mb-6">
            <Input
              placeholder={`Novo ${tab.slice(0, -1).toLowerCase()}...`}
              value={newItem}
